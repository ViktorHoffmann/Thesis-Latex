...
Das \ac{pcm} wird dort als isobar angenommen und hat eine unendliche Wärmeleitfähigkeit. Des weiteren befindet es sich
...
Da ein Würfel von allen Quadern das größte Volumen zu Oberflächenverhältnis hat, sind alle Kanten gleich lang.
...
Für eine rein radiative Kühlung der Avionik ergibt sich für \SI{40}{\watt} der Avionik und einem spezifischen Wärmestrom der Sonne von \SI{1}{\kilo\watt\per\meter\squared}
...
eine Fläche von \SI{996,163}{\centi\meter\squared}. In \ref{lst:setup_json} und \ref{lst:radiator_python_pseudo} ist der Programmcode der zur Berechnung
...
Wegen des \ac{pcm} und der Annahme, dass alle Wärmeleitkoeffizienten unendliche groß sind, wird das System als isotherm modelliert.
...
eingeklammerte Programme nicht in der Berechnung beteiligt waren aber zu Zwecken des Post-Processing und Plotten verwendet wurden:
\begin{itemize}
  \item setup.json
  \item results.json
  \item main.py
...
für die laminare Grenzschicht. Die Reynolds-Zahl überschreitet jedoch zeitweise mit Werten bis zu \SI{2.4e7} die üblichen Gültigkeitsbereiche.
Aufgrund fehlender alternativer analytischer Methoden wurde dennoch die Nußelt-Beziehung für turbulente Grenzschichten angewendet.
...
Das Ergebnis der Berechnung ist in Abbildung \ref{fig:pcm_waermestrom_vorauslegung} zu sehen. Mit einer Radiatorfläche von \SI{996,163}{\centi\meter\squared},
wie bereits in \ref{sec:Radiator} berechnet, um die Gesamtleistung der Avionik und Sonne von $\dot{Q}_\mathrm{Radiator} = \SI{47.471}{\watt} abzustrahlen und 

Erkennbar ist, dass mit bis zu \SI{20}{\kilo\watt}
ein extrem hoher Wärmestrom durch die aerodynamisch Aufheizung entsteht. Auch wenn dieser nur etwa \SI{100}{\seconds} andauert,
ist 

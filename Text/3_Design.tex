...
der Radiator Dimension mithilfe der Randbedingungen aus der \texttt{setup.json}, danach wird die \texttt{hybrid.py} aufgerufen um die Aerodynamischen Wärmeströme

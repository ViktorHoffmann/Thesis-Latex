...
Um die Masse und Dimension des \ac{pcm} zu berechnen wurde das in \ref{lst:pcm_python} dargestellte Python-Programm verwendet.
Das \ac{pcm} wird dort als isobar angenommen und hat eine unendliche Wärmeleitfähigkeit. Des weiteren befindet es sich
in einer Aluminium-Box mit \SI{1}{\milli\meter} Wanddicke.
...
\begin{lstlisting}[float, language=Python, caption={Berechnung der Masse und Latenten Wärmekapazität des \ac{pcm} in der pcm.py}, label={lst:pcm_python}]

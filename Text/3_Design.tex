...
\begin{figure}
  ...
  \caption{Kommerziell erhältliche Wärmeleitbänder aus PGS (links), Kupfer und Aluminium~\cite{Thermal-Straps}}\label{fig:thermalstraps_commercial}
\end{figure}
...
\begin{figure}
  ...
  \begin{tikzpicture}[
    ...
    \node (sonne)   at ( 2.1, 4) {Solare Bestrahlungsstärke};

...
\end{equation}
\end{minipage}
Die Dynamische Viskosität wird mittels der Sutherlands-Formel~\ref{eq:dynamische_viskositaet} berechnet, und die Recoverytemperatur mittels der adiabaten Strömungsgleichung, welche auch vom Recovery-Faktor abhängt.
\begin{equation}
...
Hier gehts jetzt um wie die wärme verteilt und abtransportiert wird.
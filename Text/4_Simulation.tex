...
\section{PCM-Radiator-Hybrid}\label{sec:sim_pcm_radiator_hybrid_sim}

Als nächstes sieht man Graphen

\section{Aerothermal}\label{sec:sim_aerothermal}
...
\section{\texorpdfstring{\ac{pcm}}{PCM}}\label{sec:sim_pcm}

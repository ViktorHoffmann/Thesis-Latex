...
Die Wärmequelle ergibt sich aus der Seitenfläche der \ac{pcm} Struktur und dem Avionik Wärmestrom zu
...
Die Thermodynamischen Eigenschaften, modelliert in der \ac{udf}, von n-Eicosan sind aufgeführt in Tabelle \ref{tab:eicosane_data}.
...
Zu der in \ref{sec:konvektion} behandelten Bossinesq-Approximation \ref{eq:udf_bouss} kommen noch 
...
Basiert größtenteils auf \cite{Irving-2021}

...
Die Stoffkonstante der Umwandlungsenthalpie ist die spezifische Umwandlungsenthalpie:
...
Aufheizung berücksichtigt wird. Dementsprechend wird $T_\text{f}$ aus \ref{eq:qdot} zu $T_\text{r}$:
...
die experimentell nur schwer oder gar nicht möglich sind.
Ziel ist es, die physikalischen Erhaltungsgleichungen auf einer
diskreten Gitterstruktur zu lösen. Diese sind die Massenerhaltung:

...
Die Dichte $\rho$ ist für das ANSYS Fluent interne Enthalpy-Porosity-Modell notwendig und kann in Abhängigkeit des Flüssigkeitsanteils $\gamma$ berechnet werden.
...
Die Dynamische Viskosität $\eta$ wird hier, anders als für Luft in der Vorauslegung \ref{eq:dynamische_viskositaet}, mittels einer empirischen

...
\noindent\begin{minipage}{.5\linewidth}
  \begin{equation}
    ...
    \tau_w = \eta \left.\frac{\partial u}{\partial y}\right|_{y=0}
  \end{equation}
\end{minipage}%
\begin{minipage}{.5\linewidth}
  \begin{equation}
...
Hierbei ist $\eta$ die dynamische Viskosität und $\left.\frac{\partial u}{\partial y}\right|_{y=0}$ der Geschwindigkeitsgradient senkrecht zur Wand.

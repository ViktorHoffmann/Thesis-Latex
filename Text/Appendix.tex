...
\begin{lstlisting}[language=Python, caption={Python-Programm hybrid.py zur analytischen Berechnung der aerodynamischen Aufheizung}, label={lst:hybrid_python_pseudo}]
    # === flight data ===
    time = raw['time']  # [s]

...
\includepdf{Text/Hoffmann_Bachelor_Eidesstatt_Druck.pdf}
...
% ----------- Diskussion & Schlussfolgerungen----------------------------------------
\newpage
\include{Text/5_Zusammenfassung}

% ----------- Ausblick --------------------------------------------------------------
\newpage
\include{Text/6_Ausblick}
...
\bibliographystyle{unsrt}%{unsrt}{abbrv}{abbrvnat}{unsrt}
